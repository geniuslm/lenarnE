...
watch(() => 行数据.镜片, 总利润计算)
watch(() => 行数据.右镜片供应商, 总利润计算)
watch(() => 行数据.左镜片供应商, 总利润计算)
      ...
      <div class="验光数据 ">
        <div :class="{ 光度: true, 客服光度: 库.当前登录用户类型 == '客服' }">
          ...
          <div v-if="库.当前登录用户类型 == '助理'" class="镜片带按钮">
            <input :class="{ 警告色: !行数据.右镜片供应商, 镜片: true, }" v-model.lazy="行数据.右镜片供应商" placeholder='右订片' list="镜片供应商">
        ...
        <div :class="{ 光度: true, 客服光度: 库.当前登录用户类型 == '客服' }">
          ...
          <div v-if="库.当前登录用户类型 == '助理'" class="镜片带按钮">
            <input :class="{ 警告色: !行数据.左镜片供应商, 镜片: true, }" v-model.lazy="行数据.左镜片供应商" placeholder='左订片' list="镜片供应商">
